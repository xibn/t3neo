    ...
    const submissionIntent =
      key === "Enter"
        ? composerSubmissionIntentForEnter({
            ...
            isDraftThread: routeKind === "draft",
            // "connecting" is a starting session, which the queue treats as busy
            // like a running one; Mod+Enter must bypass it in both cases.
            isRunning: (phase === "running" || phase === "connecting") && queueMessages,
          })
        : null;
    if (submissionIntent) {
