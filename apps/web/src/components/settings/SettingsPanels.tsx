    ...
    <SettingsPageContainer>
      ...
      <SettingsSection id="appearance-interface" title="Interface">
        <SettingsRow
          ...
          description="Neo is the T3 Neo interface with its own light and dark palette: a warm canvas, flat bordered surfaces, softly squared controls, and lighter display type. Default (Themes) is the standard T3 Code interface, where themes pick the palette."
          resetAction={
        ...
        <SettingsRow
          ...
          description="Chevrons on menus and pickers turn to face the menu while it is open and sit as drawn while it is closed. Off keeps them still."
          resetAction={
