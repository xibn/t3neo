...
import { usePetTypingSync } from "../neo/pets/usePetActivitySync";
...
function RootRouteView() {
  ...
  // The composer is here, the pet is not: relay keystrokes to its window.
  usePetTypingSync(!isPetWindowRoute);
