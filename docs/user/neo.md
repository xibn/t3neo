...
menus, pickers, and popovers turn to face the menu while it is open; while the menu is closed they
sit as drawn. A picker above the message box opens upward, so its chevron flips up while it is open
and settles back down when you close it; a menu that opens downward does the reverse. Turn the
switch off to keep every chevron still.
...
The pet floats above the app and can be dragged anywhere. The **Pet size**
